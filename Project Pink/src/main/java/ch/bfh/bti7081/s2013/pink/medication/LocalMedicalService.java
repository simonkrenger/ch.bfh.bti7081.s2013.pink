...
/**
 * Local implementation of the medical service, accessing local databases as
 * dataSources.
 * 
...
public class LocalMedicalService implements IMedicalService {
	 ...
	 */
	@Override
	public boolean prescribeMedicament(Patient patient, Medication medicament,
			Dose dose, Date startDate, Date endDate) {
		return prescribeMedicament(patient, medicament, dose, "", startDate,
				endDate);
	}
	 ...
	 * 
	 * @param medicine
	 *            medicine to be tested.
	 * @param allergy
	 *            allergy to be tested.
	 * @return flag if it conflicted.
	 */
	private boolean doesMedicamentConflictWithAllergy(Medication medicine,
			Allergy allergy) {
	 ...
	 */
	private boolean savePrescription(Patient patient, Medication medicine,
			Dose dose, String reason, Date startDate, Date endDate) {
	...
	public boolean prescribeMedicament(Patient patient, Medication medicament,
		...
		return savePrescription(patient, medicament, dose, reason, startDate,
				endDate);
	}
	 ...
	 * @return flag if prescription has been made.
	 */
	public boolean prescribeUnsafeMedicament(Patient patient,
			Medication medicament, Dose dose, String reason, Date startDate,
			Date endDate) {
